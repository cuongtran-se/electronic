    ...
    <>
      ...
      <div className="min-h-screen flex flex-col justify-center items-center bg-gray-100 p-4">
        <div className="container mx-auto max-w-5xl text-gray-500">
          <div className="py-10">
            <div className="text-3xl text-black ">Dịch Vụ Xây Lắp Điện Tỉnh Lâm Đồng Mới ( 3 Tỉnh : Lâm Đồng , Bình Thuận , Đắk Nông )</div>
           ...
           <div className="flex flex-col sm:flex-row justify-center items-center my-5 gap-2 sm:gap-4">
            ...
            <p className="text-base font-bold text-black">♦ Thiết kế, thi công đường dây trung và trạm biến áp đến cấp 35kV.</p>
            <p className="text-base font-bold text-black">♦ Kiểm định , thí nghiệm sữa chữa đường dây trung thế và trạm biến áp đến 35kV.</p>
           ...
           <div className="flex flex-col sm:flex-row justify-center items-center my-5 gap-2 sm:gap-4">
              <img
                src="/image/hinh3.jpg"
                alt="Trạm biến áp tại Bình Thuận"
